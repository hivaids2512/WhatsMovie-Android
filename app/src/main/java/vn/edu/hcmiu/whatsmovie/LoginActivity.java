    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                String json = new Client(url).doPost(jsonObject);
                JSONObject jsonObj = new JSONObject(json);

                if(!jsonObj.getString("authenticated").equals("false")){
                    new securityManager(context).writeToken("secureToken", jsonObj.getString("secureToken"));
                    return true;
                }
